...
public class AutonCommandRight extends CommandGroup {
	...
	public AutonCommandRight(AutoType autoType, TargetPriority targetPriority, PossibleCollision possibleCollision, SwitchPosition switchPosition, ScalePosition scalePosition) {
		...
		if (switchPosition == SwitchPosition.Right && scalePosition == ScalePosition.Right && autoType == AutoType.TargetBased) {
		...
		else if (switchPosition == SwitchPosition.Right && scalePosition == ScalePosition.Right && autoType == AutoType.RobotAlignmentBased) {
			doScale = (targetPriority == TargetPriority.Scale);
			doScaleAndSwitch = (targetPriority == TargetPriority.Switch);
		} 
		...
		if (doSwitch) {
			...
			addParallel(new LiftUpWithTimeout(2.0));
			addSequential(new DrivetrainFollowProfile(Trajectories.rightSwitchSpline));
			...
			addSequential(new DrivetrainFollowProfile(Trajectories.rightBackSwitchSpline));
			addSequential(new AutonIntakeOutWithTimeout(0.5));
			addParallel(new LiftDownWithTimeout(1.0));
			addSequential(new DrivetrainFollowProfile(Trajectories.driveBackward18In));
			...
			addSequential(new DrivetrainFollowProfile(Trajectories.rightScaleSpline1));
			...
			addSequential(new DrivetrainFollowProfile(Trajectories.rightScaleSpline7));
			addSequential(new DrivetrainFollowProfile(Trajectories.rightScaleSpline5));
			addSequential(new AutonIntakeOutWithTimeoutScale(1.0));
			addParallel(new LiftDownWithDelay(0.5, 3.0));
			addSequential(new DrivetrainFollowProfile(Trajectories.rightScaleSpline2));
			...
			addSequential(new DrivetrainFollowProfile(Trajectories.rightBackScaleSpline1));
			addSequential(new AutonIntakeOutWithTimeoutScale(1.0));
			addParallel(new LiftDownWithDelay(0.5, 3.0));
			addSequential(new DrivetrainFollowProfile(Trajectories.rightBackScaleSpline2));
			addParallel(new IntakeInWithTimeout(2.0));
